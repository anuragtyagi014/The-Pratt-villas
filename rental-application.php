<?php
/* Template Name: Rental Application */

get_header();
?>
<!-- Hero Section Start  -->
<!-- <section class="page__header hero-v2__section make_header-dark for-all-ani"
         style="background-image:url('https://theprattvillas.com//wp-content/uploads/2023/05/image-1.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="search__wrapper content">
                    ...
                    <h2 class="search__title text-center for-txt-ani">
                        <span class="toggle__buy active">Rental Application</span>
                    </h2>
                </div>
            </div>
        </div>
...
<main-new class="make_header-light">
    ...
    <nav class="section-nav new_class_for_hide">
        <span class="cross"><i class="fas fa-times"></i></span>
        <ol>
            <li>
                <a href="tenant-login/#tenant-resources">
                    <div class="cicled__btn">
                        <svg viewBox="0 0 24 24" class="circled__btn-outer">
                            <circle cx="12" cy="12" r="11" stroke="1" style=""></circle>
                        </svg>
    ...
    transition: 350ms;" cx="12" cy="12" r="11" stroke="1" style=""></circle>
            ...
            <li>
                <a href="tenant-login/#maintenance-request">
                    <div class="cicled__btn">
                        <svg viewBox="0 0 24 24" class="circled__btn-outer">
                            <circle cx="12" cy="12" r="11" stroke="1" style=""></circle>
                        </svg>
            ...
            <li>
                <a href="tenant-login/#payment-history">
                    <div class="cicled__btn">
                        <svg viewBox="0 0 24 24" class="circled__btn-outer">
                            <circle cx="12" cy="12" r="11" stroke="1" style=""></circle>
                        </svg>
            ...
            <li>
                <a href="tenant-login/#onboarding">
                    <div class="cicled__btn">
                        <svg viewBox="0 0 24 24" class="circled__btn-outer">
                            <circle cx="12" cy="12" r="11" stroke="1" style=""></circle>
                        </svg>

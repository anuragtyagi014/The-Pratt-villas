...
.table_data_info th, .table_data_info td {
    padding: 10px;
    text-align: center;
}
...
.table_data_info tr:nth-child(even) {background-color: #f2f2f2;}
</style>
<!-- Hero Section Start  -->
...
">  
                            ...
                            <div class="col-lg-3 col-md-6">
                                  ...
                                  <select name="size">
                                      ...
                                      <option value="1" <?php if($_POST['size'] == 1){ echo "selected"; }else{ } ?>>1</option>
                                      <option value="2" <?php if($_POST['size'] == 2){ echo "selected"; }else{ } ?>>2</option>
                                      <option value="3" <?php if($_POST['size'] == 3){ echo "selected"; }else{ } ?>>3</option>
                                      <option value="4" <?php if($_POST['size'] == 4){ echo "selected"; }else{ } ?>>4</option>
                                      <option value="5" <?php if($_POST['size'] == 5){ echo "selected"; }else{ } ?>>5</option>
                                      <option value="6" <?php if($_POST['size'] == 6){ echo "selected"; }else{ } ?>>6</option>
                                      <option value="7" <?php if($_POST['size'] == 7){ echo "selected"; }else{ } ?>>7</option>
                                      <option value="8" <?php if($_POST['size'] == 8){ echo "selected"; }else{ } ?>>8</option>
                                  </select>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                  ...
                                  <select name="bedroom">
                                      <option>--select--</option>
                                      <option value="1" <?php if($_POST['bedroom'] == 1){ echo "selected"; }else{ } ?>>1</option>
                                      <option value="2" <?php if($_POST['bedroom'] == 2){ echo "selected"; }else{ } ?>>2</option>
                                      <option value="3" <?php if($_POST['bedroom'] == 3){ echo "selected"; }else{ } ?>>3</option>
                                      <option value="4" <?php if($_POST['bedroom'] == 4){ echo "selected"; }else{ } ?>>4</option>
                                      <option value="5" <?php if($_POST['bedroom'] == 5){ echo "selected"; }else{ } ?>>5</option>
                                      <option value="6" <?php if($_POST['bedroom'] == 6){ echo "selected"; }else{ } ?>>6</option>
                                      <option value="7" <?php if($_POST['bedroom'] == 7){ echo "selected"; }else{ } ?>>7</option>
                                      <option value="8" <?php if($_POST['bedroom'] == 8){ echo "selected"; }else{ } ?>>8</option>
                                  </select>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                  ...
                                  <select name="furniscat">
                                      <option>--select--</option>
                                      <option value="Furnished" <?php if($_POST['furniscat'] == 'Furnished'){ echo "selected"; }else{ } ?>>Furnished</option>
                                      <option value="UnFurnished" <?php if($_POST['furniscat'] == 'UnFurnished'){ echo "selected"; }else{ } ?>>Unfurnished</option>
                                  </select>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                  ...
                                  <select name="bath">
                                      <option>--select--</option>
                                      <option value="1" <?php if($_POST['bath'] == 1){ echo "selected"; }else{ } ?>>1</option>
                                      <option value="2" <?php if($_POST['bath'] == 2){ echo "selected"; }else{ } ?>>2</option>
                                      <option value="3" <?php if($_POST['bath'] == 3){ echo "selected"; }else{ } ?>>3</option>
                                      <option value="4" <?php if($_POST['bath'] == 4){ echo "selected"; }else{ } ?>>4</option>
                                      <option value="5" <?php if($_POST['bath'] == 5){ echo "selected"; }else{ } ?>>5</option>
                                      <option value="6" <?php if($_POST['bath'] == 6){ echo "selected"; }else{ } ?>>6</option>
                                      <option value="7" <?php if($_POST['bath'] == 7){ echo "selected"; }else{ } ?>>7</option>
                                      <option value="8" <?php if($_POST['bath'] == 8){ echo "selected"; }else{ } ?>>8</option>
                                  </select>
                            </div>
